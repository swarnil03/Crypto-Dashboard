    ...
    render() {
        return (
            <div>
                ...
                <section className="row justify-content-center m-3 mb-0" style={{ marginTop: ' 2px !important', display: 'flex', flexWrap: 'wrap' }}>
                ...
                <div>
                    ...
                    <div style={{
                        ...
                        fontWeight: '700', color: "#FBF9F1", textDecoration: 'none solid rgb(255, 255, 255)',
                        textAlign: 'center', margin: "0px 0px 25px 0px"
                    }}>
